...
public class RecyclingPanelMapView : MonoBehaviour
{
     [Tooltip("Prefab for all the child view objects in the list")]
    public RecyclingPanelMapViewItem ChildPrefab;
    ...
    public delegate void ItemDelegate(RecyclingPanelMapViewItem item, int rowIndex);
    ...
    protected RecyclingPanelMapViewItem[] childItems;
    ...
    public virtual void Refresh(RecyclingPanelMapViewItem item) {
    ...
    public RecyclingPanelMapViewItem GetRowItem(int row) {
        if (childItems != null && 
    ...
    protected virtual bool CheckChildItems() {
        ...
        if (rebuild) {
            ...
            if (childItems == null) 
                childItems = new RecyclingPanelMapViewItem[childCount];
    ...
    protected virtual void UpdateChild(RecyclingPanelMapViewItem child, int rowIdx) {
